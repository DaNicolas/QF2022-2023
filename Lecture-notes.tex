...
For $n = 3$ it is known that such a number $m$ exists, and that it grows very fast as a function of $d$ [SOURCE].
...
We mention the following major theorem, without proof.
\begin{thm}[Arason-Pfister Hauptsatz]\label{T:Arason-Pfister}
