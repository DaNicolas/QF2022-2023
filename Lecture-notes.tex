...
\end{prop}
\begin{proof}
This follows from \Cref{L:split-off-2fold-Pfister} by induction on $m$.
\end{proof}
...
The fact that it is a group homomorphism is also easily verified.
\end{proof}
...
\end{proof}
Finally, we mention without proof the following theorem of Pfister about torsion in the Witt ring.
